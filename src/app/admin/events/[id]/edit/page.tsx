    ...
    return (
      <div className="max-w-2xl mx-auto py-10 px-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <p className="text-red-700">The event you&apos;re trying to edit doesn&apos;t exist or you don&apos;t have permission to edit it.</p>
          <button
            onClick={() => router.back()}
    ...
    return (
      <div className="max-w-2xl mx-auto py-10 px-6">
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          <h1 className="text-2xl font-bold text-green-800 mb-2">Event Updated Successfully!</h1>
